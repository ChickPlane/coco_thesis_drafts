...
From the Fig\ref{fig:C_AT}, we can make  the following observations:
\begin{enumerate}
...
%We can see that Though the difference of performance of different group numbers shows a  tendency to be similar when the average degree is larger than 5 (which is the maximum average degree shown in Fig.\ref{fig:Final}  \color {blue} ??? from where we do not give the statistics, 
