...
\end{theorem}
\begin{proof}
As in the discussing in PBVD-2G, we first discuss the number of agents that should be employed in our strategy. 
When analyzing the PBVD-qG strategy, we use the Cost Function Measurement (CFM)
