...
\noindent{\bf Comparison between the Castle First Strategy and the Sequential Strategy (GREEDY Exploration)}\\
...
%      \hspace{1in} 
  ...
  \subfigure[size of graph:100 nodes]{ 
    ...
    \includegraphics[width=2.2in]{figures/C_Move5.png}}
      \caption{Comparison between GREEDY Exploration and Castle First Strategy } 
  \label{fig:C_Move}%% label for entire figure 
\end{figure}
From Figure\ref{fig:C_Move}, we have the following observations of the time:
\begin{enumerate}
...
\begin{figure} [H]
  \centering 
  \subfigure[Ratio of the number of agent used in Castle First Strategy using one group of agent to the number of agent used in GREEDY Exploration]{ 
    \label{fig:C_AT1:a} %% label for first subfigure 
    \includegraphics[width=2.5in]{figures/C_AT1.png}} 
    \hspace{1in} 
  \subfigure[Ratio of the time cost by Castle First Strategy using one group of agent to the time cost by the GREEDY Exploration]{ 
...
From the Fig\ref{fig:C_AT}, we have the following observations:
\begin{enumerate}
