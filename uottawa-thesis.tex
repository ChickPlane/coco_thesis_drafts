...
% C O V E R  P A G E
% ------------------
\newcommand{\thesisauthor}{Yichao Lin}
\newcommand{\thesistitlecoverpage}{Decontamination from Black Viruses\\Using Parallel Strategies}%
\newcommand{\degree}{Master} % possible values are:
...
\input{parts/chapter7}
\input{parts/chapter8}
...
%
%\include{parts/appendix} %"Sources of Information and Help"
