...
\begin{figure}[h!]
  \centering
    \reflectbox{%
      \includegraphics[width=0.3\textwidth]{figures/dloop.jpg}}
...
\begin{figure}[h!]
  \centering
    \reflectbox{%
      \includegraphics[width=0.3\textwidth]{figures/tloop.jpg}}
...
\begin{figure}[h!]
  \centering
    \reflectbox{%
      \includegraphics[width=0.3\textwidth]{figures/cloop.jpg}}
